...
namespace GateKeeperV1.Migrations
{
    ...
    [Migration("20241231165534_fix-movement-shift-relation-and-navigation")]
    partial class fixmovementshiftrelationandnavigation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GateKeeperV1.Models.ShiftDaysOfWeek", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GateKeeperV1.Models.Shift", b =>
                {
                    ...
                    b.HasOne("GateKeeperV1.Models.WorkerProfile", "ShiftLeader")
                        .WithMany("LeaderOfShifts")
